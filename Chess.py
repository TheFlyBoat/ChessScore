...
# Google Sheets Setup
# Use Streamlit secrets to get Google credentials
creds_dict = st.secrets["google_credentials"]  # Access credentials directly from secrets

# Fixing potential formatting issues with private_key
creds_dict = dict(creds_dict)  # Convert to a normal dictionary to avoid item assignment issues
...
st.write("""
---
Developed collaboratively. Let's continue to add more features!
""")
